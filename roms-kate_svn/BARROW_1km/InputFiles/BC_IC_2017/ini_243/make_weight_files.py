...
dstgrd = pycnal.grid.get_ROMS_grid('BARROW_1km')
...
for typ in type:
    for tip in type:
        ...
        grid2_file = 'remap_grid_BARROW_1km_'+str(tip)+'.nc'
        interp_file1 = 'remap_weights_ARCTIC4_to_BARROW_1km_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_BARROW_1km_to_ARCTIC4_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'ARCTIC4 to BARROW_1km Bilinear Mapping'
        map2_name = 'BARROW_1km to ARCTIC4 Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
