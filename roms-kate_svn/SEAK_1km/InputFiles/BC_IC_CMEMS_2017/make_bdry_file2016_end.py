...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SEAK_2016/dum/'
...
dst_grd = pycnal.grid.get_ROMS_grid('SEAK_1km')
...
for file in lst_file:
    ...
    dst_grd = pycnal.grid.get_ROMS_grid('SEAK_1km', zeta=zeta)
