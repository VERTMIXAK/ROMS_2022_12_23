...
/* What I want here is no surface forcing at all
	Not inputing surface forcing data files doesn't work
	because ROMS'll look for them anyway. What I have to 
	do is tell ROMS I'll use analytic functions to
	calculate surface fluxes, and then game the
	routines to just output zeros.	
*/
