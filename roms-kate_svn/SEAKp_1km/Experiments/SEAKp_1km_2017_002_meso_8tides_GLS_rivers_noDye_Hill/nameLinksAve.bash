...
for file in ./netcdfOutput*/*avg_?????.nc
do
    echo $file
...
echo "date $date"
   ...
   ln $file "netcdfOutput_nameLinks/"$newName
	...
	newFile=`echo $file | sed -e 's/avg/his2/'`
	newName=`echo $newName | sed -e 's/avg/his2/'`
	echo $newFile $newName
    ln $newFile "netcdfOutput_nameLinks/"$newName

	newFile=`echo $newFile | sed -e 's/his2/his/'`
    newName=`echo $newName | sed -e 's/his2/his/'`
    echo $newFile $newName
    ln $newFile "netcdfOutput_nameLinks/"$newName
