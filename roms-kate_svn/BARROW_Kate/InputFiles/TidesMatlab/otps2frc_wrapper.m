...
gfile='../KatesInputFiles/grid_Barrow_1.nc'
...
pred_date=datenum(2018,09,15);

ofile='AllComponents_2018.nc';
model_file='DATA/Model_tpxo7.2';
% model_file='/import/VERTMIXFX/jgpender/ROMS/OTIS_DATA/Model_tpxo7.2';
otps2frc_v5(gfile,base_date,pred_date,ofile,model_file,'BoB3_4km')
