...
dstgrd = pycnal.grid.get_ROMS_grid('BARROW_Kate')
...
for typ in type:
    for tip in type:
        ...
        grid2_file = 'remap_grid_BARROW_Kate_'+str(tip)+'.nc'
        interp_file1 = 'remap_weights_ARCTIC4_to_BARROW_Kate_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_BARROW_Kate_to_ARCTIC4_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'ARCTIC4 to BARROW_Kate Bilinear Mapping'
        map2_name = 'BARROW_Kate to ARCTIC4 Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
