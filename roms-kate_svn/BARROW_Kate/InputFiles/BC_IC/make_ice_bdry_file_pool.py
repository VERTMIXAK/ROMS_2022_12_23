...
part_filename = '/import/c1/VERTMIX/jgpender/roms-kate_svn/BARROW_Kate/InputFiles/KatesSourceFiles/avgs2/arctic4_avg2_2018-'

wts_file = "./ini_243/remap_weights_ARCTIC4_to_BARROW_Kate_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('ARCTIC4')
dst_grd = pycnal.grid.get_ROMS_grid('BARROW_Kate')
