icFile = 'ini_091_120E_20.5N/CMEMS_2007_091_ic_SCSAtelescope_4km.nc';

regBCFile = 'CMEMS_2007_bdry_SCSAtelescope_4km.nc';
nullBCFile = 'CMEMS_2007_bdry_SCSAtelescope_4km_120E_20.5N.nc';

unix(['cp ',regBCFile,' ',nullBCFile]);

time = nc_varget(nullBCFile,'ocean_time');
nt = length(time);
