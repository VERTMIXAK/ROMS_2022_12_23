...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018_orig/data_PHY/CMEMS_PHY_135.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018_orig/CMEMS_NISKINE_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('NISKINESAB_1km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NISKINESAB_1km', zeta=zeta)
