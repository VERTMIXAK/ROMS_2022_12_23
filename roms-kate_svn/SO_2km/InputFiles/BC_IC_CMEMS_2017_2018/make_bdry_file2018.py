...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SO_2018/data/'
...
src_grd_file = data_dir + '../CMEMS_SO_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SO_2km')
...
for file in lst_file:
    ...
    dst_grd = pycnal.grid.get_ROMS_grid('SO_2km', zeta=zeta)
