...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SCSA_2007/data_PHY/CMEMS_PHY_2007_090.nc'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SCSA_2007/CMEMS_SCSA_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SCSA_4km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SCSA_4km', zeta=zeta)
