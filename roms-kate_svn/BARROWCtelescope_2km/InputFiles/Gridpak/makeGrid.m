...
% The idea here is to take a perfectly regular 2km grid and add telescoping
% sections to the north and east edges.

% The corners for the rectilinear BARROW_2km grid (sqgrid.in_noTele) are:
p1=[-504605.829085986,-1750524.47149043]
p2=[-500350.39556755,-2342509.17677053]
p3=[419625.835610988,-2335896.00305945]
p4=[415370.402092552,-1743911.29777935]
...
% The original grid is a very even 2km. Telescope out to 6.25 km intervals over a
% distance of about 100km. Keep fiddling with myStretch until the
...
myNx = round((xmax-xmin)/2000);
myNy = round((ymax-ymin)/2000);

newX = [lhsX xmin:(xmax-xmin)/myNx:xmax rhsX];
newY = [ymin:(ymax-ymin)/myNy:ymax topY];
