...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2019/data_PHY/CMEMS_2019_146.nc'
dst_dir='./'
...
dst_grd = pycnal.grid.get_ROMS_grid('NISKINE_SA_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NISKINE_SA_2km', zeta=zeta)
