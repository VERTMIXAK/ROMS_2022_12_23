...
bFile = '/import/c1/VERTMIX/jgpender/roms-kate_svn/PALAU_120C_UH_Direct/InputFiles/frinkiac/fleatInner_palauBB_grid.nc';
% bFile = 'fleat_inner_grid.nc';
bLon  = nc_varget(bFile,'lon_psi');
bLat  = nc_varget(bFile,'lat_psi');


%% get my first-cut grid

jFile = '../Gridpak_firstCut/PALAU_800m.nc_firstCut';
