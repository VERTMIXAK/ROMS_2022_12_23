...
grd = pycnal.grid.get_ROMS_grid('BARROW_500m')

m = Basemap(projection='lcc',lat_1=71.25, lat_2=74.25, lon_0=209, lat_0=73, width=5000000, height=5000000, resolution='h')
