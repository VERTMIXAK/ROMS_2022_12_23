...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2019/data_PHY/CMEMS_2019_147.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2019/CMEMS_NISKINE_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('NISKINE_SA_2km_TELESCOPE')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NISKINE_SA_2km_TELESCOPE', zeta=zeta)
