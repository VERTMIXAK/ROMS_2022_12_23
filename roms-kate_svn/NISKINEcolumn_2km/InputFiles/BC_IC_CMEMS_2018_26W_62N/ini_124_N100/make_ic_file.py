...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018/data_PHY/CMEMS_PHY_124.nc'
dst_dir='./'
...
dst_grd = pycnal.grid.get_ROMS_grid('NISKINEcolumn_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NISKINEcolumn_2km', zeta=zeta)
