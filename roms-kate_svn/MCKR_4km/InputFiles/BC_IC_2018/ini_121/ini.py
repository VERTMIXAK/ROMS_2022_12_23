...
src_filename = '/import/AKWATERS/kshedstrom/Arctic4/run16/averages/arctic4_avg_2018-05-01T.nc'
wts_file = "./remap_weights_ARCTIC4_to_MCKR_4km_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('ARCTIC4')
dst_grd = pycnal.grid.get_ROMS_grid('MCKR_4km')
