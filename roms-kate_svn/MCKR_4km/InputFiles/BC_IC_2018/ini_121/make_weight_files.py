...
dstgrd = pycnal.grid.get_ROMS_grid('MCKR_4km')
...
for typ in type:
    for tip in type:
        ...
        grid2_file = 'remap_grid_MCKR_4km_'+str(tip)+'.nc'
        interp_file1 = 'remap_weights_ARCTIC4_to_MCKR_4km_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_MCKR_4km_to_ARCTIC4_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'ARCTIC4 to MCKR_4km Bilinear Mapping'
        map2_name = 'MCKR_4km to ARCTIC4 Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
