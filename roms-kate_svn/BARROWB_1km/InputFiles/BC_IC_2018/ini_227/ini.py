...
src_filename = '/import/AKWATERS/kshedstrom/Arctic4/run16/averages/arctic4_avg_2018-08-15T.nc'
wts_file = "./remap_weights_ARCTIC4_to_BARROWB_1km_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('ARCTIC4')
dst_grd = pycnal.grid.get_ROMS_grid('BARROWB_1km')
