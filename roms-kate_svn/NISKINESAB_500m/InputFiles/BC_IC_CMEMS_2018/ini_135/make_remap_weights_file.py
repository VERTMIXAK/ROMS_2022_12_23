...
dstgrd = pycnal.grid.get_ROMS_grid('NISKINESAB_500m')
...
grid2_file = 'remap_grid_NISKINESAB_500m_rho.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NISKINESAB_500m_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_NISKINESAB_500m_to_GLBa0.08_bilinear_rho_to_t.nc'
map1_name = 'GLBa0.08 to NISKINESAB_500m Bilinear Mapping'
map2_name = 'NISKINESAB_500m to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_NISKINESAB_500m_u.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NISKINESAB_500m_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_NISKINESAB_500m_to_GLBa0.08_bilinear_u_to_t.nc'
map1_name = 'GLBa0.08 to NISKINESAB_500m Bilinear Mapping'
map2_name = 'NISKINESAB_500m to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_NISKINESAB_500m_v.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NISKINESAB_500m_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_NISKINESAB_500m_to_GLBa0.08_bilinear_v_to_t.nc'
map1_name = 'GLBa0.08 to NISKINESAB_500m Bilinear Mapping'
map2_name = 'NISKINESAB_500m to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
