...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018/data_PHY/CMEMS_PHY_2018_134.nc'
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018/data_PHY/CMEMS_PHY_2018_135.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NISKINE_2018/CMEMS_NISKINE_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('NISKINESAB_500m')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NISKINESAB_500m', zeta=zeta)
