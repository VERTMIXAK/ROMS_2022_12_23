...
% lat0 = 5.5;  lat1 = 10;
lon0 = 333.75;lon1 = 339.9;
lat0 = 56.75;  lat1 = 58.9;
...
subplot(2,2,2)
imagesc(model.lon,model.lat,mod(model.pha_ubar+180,360)-180);axis xy;
% caxis([0,30]);
rect;hold on
...
subplot(2,2,4)
imagesc(model.lon,model.lat,mod(tpxo.pha_ubar_BB+180,360)-180);axis xy;
caxis([-35,25]);
rect;hold on
