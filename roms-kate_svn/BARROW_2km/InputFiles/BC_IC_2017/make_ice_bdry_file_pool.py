...
part_filename = '/import/c1/VERTMIX/jgpender/roms-kate_svn/BARROW_Kate/InputFiles/KatesSourceFiles/averages2/arctic4_avg2_2017-'
#part_filename = '/import/AKWATERS/kshedstrom/Arctic4/run16/averages2/arctic4_avg2_2017-'

wts_file = "./ini_182/remap_weights_ARCTIC4_to_BARROW_2km_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('ARCTIC4')
dst_grd = pycnal.grid.get_ROMS_grid('BARROW_2km')
