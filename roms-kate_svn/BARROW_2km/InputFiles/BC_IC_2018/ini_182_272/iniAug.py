...
src_varname = ['u_eastward','v_northward','temp','salt']
...
src_filename = '/import/c1/VERTMIX/jgpender/roms-kate_svn/BARROW_Kate/InputFiles/KatesSourceFiles/averages/arctic4_avg_2018-08-31T.nc'
wts_file = "./remap_weights_ARCTIC4_to_BARROW_2km_bilinear_*"
