...
def remap_bdry_uv(src_file, src_grd, dst_grd, dxy=20, cdepth=0, kk=2, dst_dir='./'):
    ...
    # get weights file
    wts_file = './ini_091_regStart/remap_weights_GLBa0.08_to_SCSA_2km_bilinear_t_to_rho.nc'
    ...
    # rotate u,v fields
    src_angle = pycnal.remapping.remap(src_grd.angle, './ini_091_regStart/remap_weights_GLBa0.08_to_SCSA_2km_bilinear_t_to_rho.nc', \
                                      spval=spval)
