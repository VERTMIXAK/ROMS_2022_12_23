...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SCSA_2007/data_PHY/CMEMS_PHY_2007_091.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SCSA_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SCSA_2km', zeta=zeta)
