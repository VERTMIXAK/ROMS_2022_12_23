...
python regrid_runoff.py BARROWtelescope_2km -z --regional_domain -f /import/c1/AKWATERS/kate/JRA55-do/runoff_JRA55-do-1-4-0_${year}.* Barrow_runoff_${year}.nc > log
